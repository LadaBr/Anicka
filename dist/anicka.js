...
`;var M="768px",Y="1024px";var N=(t,e)=>`
    @media (min-width: ${t}) {
        ${e}
    }
...
`;var $=t=>{let e=document.head.querySelector('[href*="css/all.min.css"]');if(e)t.prepend(e.cloneNode());else{let r=document.createElement("style");r.textContent=it,t.prepend(r)}};var v=class extends HTMLElement{constructor(){super(...arguments);this.background="";this.radius=""}componentDidMount(){this.shadowRoot&&$(this.shadowRoot);let r=this.shadowRoot?.querySelector(".hide");r&&(r.onclick=()=>{this.style.display="none"})}};l([h("style.--notification-bg-color"),m()],v.prototype,"background",2),l([h("style.--notification-border-radius"),m()],v.prototype,"radius",2),v=l([f({template:`
    ...
    `})],x);var w=class extends HTMLElement{constructor(){super();this.delayStyle=""}set delay(r){this.delayNum=Number(r),this.delayStyle=`${this.delayNum}s`}componentDidMount(){if(this.parentElement){let r=[...this.parentElement.querySelectorAll("app-animated-text")],o=r.indexOf(this);if(o===0)return;let i=r[o-1].getAttribute("delay"),n=(i?Number(i):0)+(this.delayNum===void 0?1:this.delayNum);this.setAttribute("delay",n.toString()),this.style.setProperty("--animate-delay",`${n}s`)}}};l([m()],w.prototype,"delay",1),l([h("style.--animate-delay")],w.prototype,"delayStyle",2),w=l([f({template:"<slot></slot>",style:`
        :host {
            --animate-duration: 1s;
            --animate-delay: 0s;
            --animate-repeat: 1;
